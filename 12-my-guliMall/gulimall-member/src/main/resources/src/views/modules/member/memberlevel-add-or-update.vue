<template>
  <el-dialog
    ...
    <el-form-item label="是否为默认等级" prop="defaultStatus">
      <el-input v-model="dataForm.defaultStatus" placeholder="是否为默认等级"></el-input>
    </el-form-item>
    ...
    <el-form-item label="是否有生日价格特权" prop="priviledgeBirthday">
      <el-input v-model="dataForm.priviledgeBirthday" placeholder="是否有生日价格特权"></el-input>
    </el-form-item>
    <el-form-item label="被准" prop="note">
      <el-input v-model="dataForm.note" placeholder="被准"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          priviledgeBirthday: [
            { required: true, message: '是否有生日价格特权不能为空', trigger: 'blur' }
          ],
          note: [
            { required: true, message: '被准不能为空', trigger: 'blur' }
          ]
        }
      }
    },
