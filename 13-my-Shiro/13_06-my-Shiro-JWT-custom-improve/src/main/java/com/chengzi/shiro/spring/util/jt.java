...
public class jt {
    ...
    public static void main(String[] args) {
        String chengli = generate("chengli");
        System.out.println(chengli);
        Claims parse = parse("eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJjaGVuZ2xpIiwiaWF0IjoxNjA4Nzk1MjcyLCJleHAiOjE2MDg3OTg4NzF9.PU67sshEs5yERl68FbjnNg4ZyQ2EKQd-qjjfb74IxoF89DDADhHe7icA7Ep6efQRtFtjt9TCnto4q6GoLkb12g");
